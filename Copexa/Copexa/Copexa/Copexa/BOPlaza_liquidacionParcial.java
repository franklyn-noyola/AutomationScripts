...
public class BOPlaza_liquidacionParcial{	
	...
	public void liquidacionParcialInit() throws Exception{
		...
		liquidacionParcial();
		Thread.sleep(1000);
		actualResults.set(4,"Se ha creado una liquidación parcial No. "+liquidacionNumbr+" con el No. de Turno: "+shiftNumbr+" y un Total en Bolsa: "+bagTotal);
		Thread.sleep(1000);
		...
		testLink();
		Thread.sleep(1000);
		System.out.println("Se ha creado una liquidación parcial No. "+liquidacionNumbr+" con el No. de Turno: "+shiftNumbr+" y un Total en Bolsa: "+bagTotal);
