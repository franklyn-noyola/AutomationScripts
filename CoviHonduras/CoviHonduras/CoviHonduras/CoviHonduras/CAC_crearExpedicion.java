...
public class CAC_crearExpedicion{
	private String testNameSelected = this.getClass().getSimpleName();
			...
			public void crearExpedicion() throws Exception{
				...
				try{
					...
					//Paso 4.- Ya en la pantalla principal de Crear Expedición, hacer click en el botón Confirmar
					...
					if (rowResults.size()<2) {
						...
						driver.close();
						testLink();
						System.err.println("No se puede crear Expedición debido a que no hay Bolsas disponibles para hacer Expedición");
					...
					driver.close();
					testLink();
					System.out.println ("Se ha creado una Expedición con un total de: "+totalExpedido);
					System.out.println("Se ha probado en la versión del: "+ getVersion(applevelTested));
