	...
	private String testNameSelected = this.getClass().getSimpleName();
			...
			public void reiniciarVia() throws Exception {
				...
				try{
					...
					takeScreenShot("E:\\Selenium\\","reiniciarViaResults"+timet+".jpeg");
					takeScreenShot("E:\\Workspace\\"+projectNamePath+testClassName+"\\attachments\\","reiniciarViaResults.jpeg");
