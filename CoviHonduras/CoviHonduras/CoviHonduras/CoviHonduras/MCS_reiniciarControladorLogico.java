...
public class MCS_reiniciarControladorLogico{
	private String testNameSelected = this.getClass().getSimpleName();
			...
			@Test
			public void reiniciarControladorLogico() throws Exception {
				...
				try{
					...
					Thread.sleep(600);
					elementClick("Reiniciar controlador lógico");
					Thread.sleep(600);
					if (isAlertPresent()){
					...
					takeScreenShot("E:\\Workspace\\"+projectNamePath+testClassName+"\\attachments\\","reiniciarControladorResults.jpeg");
