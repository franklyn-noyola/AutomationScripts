...
public class BOHost_assignPersonaAutorizadaCuenta{
			...
			public void assignPersonaAutorizadaInit() throws Exception {
				...
				Thread.sleep(1000);
				if (NumbPerC) {
					actualResults.set(7, "No se puede "+optionSelected+" una persona autorizada en la cuenta "+accountNumbr+" porque no tiene Personas creadas");
					...
					driver.close();
					testLink();
					System.out.println("No se puede "+optionSelected+" una persona autorizada en la cuenta "+accountNumbr+" porque no tiene Personas creadas");
			...
			public static void assignPersonaAutorizada() throws Exception {
				...
				try {
					...
					takeScreenShot("E:\\Selenium\\","homeItataHomePage"+timet+".jpeg");
					takeScreenShot("E:\\Workspace\\Itata\\BOHost_assignPersonaAutorizadaCuenta\\attachments\\","homeItataHomePage.jpeg");
					...
					//Paso 8.- Hacer click en cualquier opción que sea pertinente Crear (crear una nueva persona autorizada), Modificar o Eliminar (si hay personas autorizadas existentes, se debe elegir primero la pesona autorizada)
					...
					switch (optionSelected) {
						case "Crear":				elementClick("ctl00_ContentZone_BtnCreate");
													break;
						case "Modificar":			elementClick("ctl00_ContentZone_BtnModify");
													break;
