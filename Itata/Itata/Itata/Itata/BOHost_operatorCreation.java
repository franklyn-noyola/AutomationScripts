...
public class BOHost_operatorCreation extends Generic_Settingsfields_File {
			...
			public void crearOperadores() throws Exception {
				...
				try{
					...
					actualResults.set(7, "Se ha Creado el operador "+lastcreated+" con la contraseaña: "+pwdCreate+ " en el grupo de "+operatorG.substring(04));
					System.out.println("Se ha Creado el operador "+lastcreated+" con la contraseaña: "+pwdCreate+ " en el grupo de "+operatorG.substring(04));		
					...
					if (transaction[0]==null){
						...
						erroTextBug = "ERROR: La Telecarga de Operadores no ha bajado a Plaza aún";
						componentBug = "HM";
						severityBug = 1;
						priority = 4;
						testFailed = true;
